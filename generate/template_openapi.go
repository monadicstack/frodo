...
// TemplateClientOpenAPI is the text template that generates the OpenAPI/Swagger JSON for your API
var TemplateClientOpenAPI = parseArtifactTemplate("openapi.yml", `# Code generated by Frodo from {{ .Path }} - DO NOT EDIT
#
